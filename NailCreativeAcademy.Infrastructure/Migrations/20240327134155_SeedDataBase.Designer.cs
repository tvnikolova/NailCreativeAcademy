...
namespace NailCreativeAcademy.Infrastructure.Migrations
{
    ...
    [Migration("20240327134155_SeedDataBase")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "44b0d19d-dbae-443b-8278-ed8bc35e41bb",
                            Email = "t_nikolova1985@abv.bg",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "student1@abv.bg",
                            NormalizedUserName = "t_nikolova1985@abv.bg",
                            PasswordHash = "AQAAAAEAACcQAAAAEPl1dGmXTMaEmxOz8ylU80lnBlvv87/k8EmEQQ6Jt/2O/uhiBvEvxcEIY1LlUXimvw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "19b3410e-adc5-4215-91e7-518e63a48c0c",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3451a373-38ed-4322-8ea2-1119a46a2e58",
                            Email = "student1@abv.bg",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "student1@abv.bg",
                            NormalizedUserName = "student1@abv.bg",
                            PasswordHash = "AQAAAAEAACcQAAAAEGso+2xghabP5DWxVm/nCZsur+LiMqPl9oEV+7HAN++yMhZJdDQPEILN5or4nXMb1A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "fee3364c-193a-4b8e-8399-67badbf078d5",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6bb16938-fce0-4358-bf77-5b3fc179092b",
                            Email = "student2@abv.bg",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "student2@abv.bg",
                            NormalizedUserName = "student2@abv.bg",
                            PasswordHash = "AQAAAAEAACcQAAAAEAf+E16pJbK9RMzV2Z4ZlfH8p0/WPapqvt5MikEMEhmQmkht8H2IxVouMrmd1e3qww==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "22c71277-f764-4804-8c89-2967cd8c4976",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1af01644-d71d-491e-84ec-426f265881db",
                            Email = "client1@abv.bg",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "client1@abv.bg",
                            NormalizedUserName = "client1@abv.bg",
                            PasswordHash = "AQAAAAEAACcQAAAAEP7gk55NWV8IAYlCEGbl9FlFF1WNOkZXKaWH0T4r2RQhhMUTn7GGfogxkwCqptGfMQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "0e144c42-ad3d-447e-bbeb-b4e80144100a",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("NailCreativeAcademy.Infrastructure.Data.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseTypeId = 1,
                            Details = "Курсът е за:\r\n- за начинаещи,\r\n- за маникюристи, които искат да обогатят знанията си.Състои се от теоретична и практическа част. Включва всички основни знания, от които се нуждае всеки бъдещ маникюрист.\",",
                            Duration = "40 часа",
                            ...
                            StartDate = new DateTime(2016, 5, 2, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TrainerId = 3
                        });
                });
            ...
            modelBuilder.Entity("NailCreativeAcademy.Infrastructure.Data.Models.Trainer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            About = "Евгения Макаренко е обучител по маникюр и педикюр. Тя е с над 11 години опит и е сертифицирана в Украйна. Евгения провежда курсове по класически маникюр, класически педикюр и ноктопластика с гел.",
                            FirstName = "Евгения",
                            LastName = "Макаренко"
                        });
                });
